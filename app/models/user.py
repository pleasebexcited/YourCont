...
User holds the details for one YourCont account in memory (user id, names, email,
and password hash).
...
This keeps account data separate from a single web request,
which matches the models layer on my class diagram.
"""
...
class User:
    ...
    def __init__(self, user_id, first_name, last_name, email, password_hash):
        ...
        # Only the hash is kept here.
        # The original password is never stored on this object.
