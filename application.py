...
YourCont starts from this file on my PC, and Elastic Beanstalk can use the same entry point later in the cloud.
create_app in app/__init__.py builds the website, then this file either hands that object to a production server or runs Flask's small local server while I check screens and auth.
